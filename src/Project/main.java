...
public class main {
	...
	public static void main(String[] args) {
		...
		Incidencia incidencia2 = gestorIncidencias.crearIncidencia("93218185J", "Lois Rego", "+34999999999", "Uno de los bancos del parque de Vista Alegre se ha roto", "Parque de Vista Alegre", "mobiliario público");
		Incidencia incidencia3 = gestorIncidencias.crearIncidencia("93218185J", "Noelia Rey", "+34999999999", "Uno de los bancos del parque de Vista Alegre se ha roto", "Parque de Vista Alegre", "mobiliario público");
		Incidencia incidencia4 = gestorIncidencias.crearIncidencia("93218185J", "Miguel Torres", "+34999999999", "Uno de los bancos del parque de Vista Alegre se ha roto", "Parque de Vista Alegre", "mobiliario público");
		Incidencia incidencia5 = gestorIncidencias.crearIncidencia("93218185J", "Clara Suárez", "+34999999999", "Uno de los bancos del parque de Vista Alegre se ha roto", "Parque de Vista Alegre", "mobiliario público");
		...
		Proceso proceso3 = gestorProcesos.crearProceso("Arreglo banco 3", "Uno de los bancos del parque de Vista Alegre está roto", 0.01f, 1, "pendiente", "Ana García", "arreglo", gestorIncidencias.getIncidencias("nombreCiudadano", "Noelia Rey"));
		System.out.println(proceso.toString());
		System.out.println(proceso2.toString());
